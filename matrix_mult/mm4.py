...
# Keep only the multiplied vector column
final_df = multiplied_df.select("multiplied_vector")
...
final_df.write.mode("overwrite").option("header", "true").csv(multiplied_output_path)
