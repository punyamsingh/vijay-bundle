...
# matrix_A_path = "hdfs://hadoop-namenode:9820/project/matrix_A.parquet"
# matrix_B_path = "hdfs://hadoop-namenode:9820/project/matrix_B.parquet"
...
# Convert result back to string for easier saving in CSV
...
multiplied_df.show(10, truncate=False)

print(f"Multiplied matrix saved to HDFS at {multiplied_output_path}")

# Stop the Spark session
spark.stop()
# # Load the matrices from HDFS
# df_A = spark.read.parquet(matrix_A_path)
# df_B = spark.read.parquet(matrix_B_path)
...
# # Save the multiplied result back to HDFS
# multiplied_output_path = "hdfs://hadoop-namenode:9820/project/multiplied_matrix.parquet"
# multiplied_df.write.mode("overwrite").parquet(multiplied_output_path)

# # Print the result
# multiplied_df.show(10, truncate=False)  # Print the first 10 rows
