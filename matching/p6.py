...
edges = edges.map(lambda line: tuple(line.split()[:2]))  # Only protein1 and protein2
...
sc.setCheckpointDir("hdfs://hadoop-namenode:9820/project/matching-checkpoints_protein")
...
def flatten_edge(edge):
    u, v = edge
    # Ensure both u and v are strings
...
final_matching_clean.saveAsTextFile("hdfs://hadoop-namenode:9820/project/protein_matching_result")
